...
def test_e2e_IMdbsearchvalidation(playwright: Playwright, browser_instance, movie_mame):
    # movie_name = "The Crack: Inception"
    omdb_api_object = OMdbAPIUtils()
    search_api_data = omdb_api_object.search_Movie(playwright, movie_mame)
    ...
    imdb_search.navigateToSearchedMoviePage(movie_mame, search_api_data["imdb_id"])
